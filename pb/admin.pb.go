...
const file_admin_proto_rawDesc = "" +
	"\n" +
	"\vadmin.proto\x12\x06global\x1a\x1cgoogle/api/annotations.proto\"F\n" +
	"\fLoginRequest\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\"R\n" +
	"\fLoginSuccess\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12,\n" +
	"\buserInfo\x18\x02 \x01(\v2\x10.global.UserInfoR\buserInfo\"g\n" +
	"\rLoginResponse\x12\x12\n" +
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12(\n" +
	"\x04data\x18\x03 \x01(\v2\x14.global.LoginSuccessR\x04data\"%\n" +
	...
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12$\n" +
	"\x04data\x18\x03 \x01(\v2\x10.global.UserInfoR\x04data2\x8c\x02\n" +
	"\x04Auth\x12P\n" +
	"\x05Login\x12\x14.global.LoginRequest\x1a\x15.global.LoginResponse\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/api/auth/login\x12T\n" +
	"\x06Logout\x12\x15.global.LogoutRequest\x1a\x16.global.LogoutResponse\"\x1b\x82\xd3\xe4\x93\x02\x15:\x01*\"\x10/api/auth/logout\x12\\\n" +
	"\vGetUserInfo\x12\x17.global.UserInfoRequest\x1a\x18.global.UserInfoResponse\"\x1a\x82\xd3\xe4\x93\x02\x14\x12\x12/api/auth/userinfoB\x10Z\x0em7s.live/v5/pbb\x06proto3"
